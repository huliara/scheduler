...
from app.schemas.taskdetail import TaskDetailCreate
...
def post(task: TaskDetailCreate, current_user: User, db: Session):
...
def patch(request: TaskDetailCreate, task_id: str, db: Session):
