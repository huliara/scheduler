...
from app.ddd.infra.repository import TemplateRepository,TaskDetailRepository
...
def __usecase_di(db:Session=Depends(get_db)):
    return TemplateDeleteSlotUseCase(db,TemplateRepository(db),TaskDetailRepository(db))
