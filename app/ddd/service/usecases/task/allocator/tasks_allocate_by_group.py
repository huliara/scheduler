...
class TaskAllocationByGroup(TransactionUseCaseBase):
    def __init__(self,db:Session,task_repository:IShiftRepository,group_repository:IGroupRepository):
        super().__init__(db)
        self.task_repository=task_repository
        self.group_repository=group_repository
    
    async def execute(self, task_ids:list[ShiftId],group_id:GroupId):
    ...
    def _transaction(self, task_ids:list[ShiftId], group_id:GroupId):
